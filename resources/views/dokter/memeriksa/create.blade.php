            ...
            <div class="bg-white p-8 shadow-lg rounded-lg">
                <form action="{{ route('dokter.memeriksa.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tgl_periksa" class="form-control w-full" value="{{ date('Y-m-d') }}" required>
                        @error('tgl_periksa')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="catatan" class="form-control w-full" rows="3" required>{{ old('catatan') }}</textarea>
                        @error('catatan')
                            <div class="text-red-600 text-sm mt-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="totalBiaya" class="form-control w-full bg-gray-100 font-bold" value="Rp{{ number_format(100000,0,',','.') }}" readonly>
                    ...
                    <div class="flex gap-2 justify-end mt-6">
                        ...
                        <button type="submit" class="btn btn-primary px-5 py-2 rounded">Simpan Pemeriksaan</button>
                    </div>
                </form>
            </div>
        </div>
